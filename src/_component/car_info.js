                    ...
                    <Tab label={___.base_info}>
                        <Table>
                            <TableBody displayRowCheckbox={false}>
                                ...
                                <TableRow >
                                    <TableRowColumn style={styles.td_left}>{___.car_depart}</TableRowColumn>
                                    <TableRowColumn style={styles.td_right}>{getDepart(car.departId)}</TableRowColumn>
                                </TableRow>
                                {/*<TableRow >
                                    <TableRowColumn style={styles.td_left}>{___.on_manage}</TableRowColumn>
                                    <TableRowColumn style={styles.td_right}><Checkbox name='onManage' onCheck={this.onManageChange} defaultChecked={this.state.onManage} /></TableRowColumn>
                                </TableRow>
                                <TableRow >
                                    <TableRowColumn style={styles.td_left}>{___.management}</TableRowColumn>
                                    <TableRowColumn style={styles.td_right}>{car.managers}</TableRowColumn>
                                </TableRow>*/}
                            </TableBody>
                        </Table>
